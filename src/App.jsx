  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-gray-200">
      <header className="border-b border-gray-800 bg-[#111] sticky top-0 z-30 p-4 flex justify-between items-center shadow-xl">
        ...
        <button onClick={() => setIsModalOpen(true)} className="bg-orange-600 p-2 rounded-lg text-white shadow-lg shadow-orange-900/20 active:scale-95 transition-all"><PlusCircle /></button>
      </header>
